...
public class TelegramBotService
{
    ...
    public TelegramBotService(Logger logger, ProPlayersService proPlayersService, ProTeamsService proTeamsService, HeroService heroService, string api) 
    {
        ...
        _client = new TelegramBotClient(api);
        _bot = _client.GetMe().GetAwaiter().GetResult();
    }

    public void StartTelegramBot()
    {
        _logger.Information($"Hello, World! I am user {_bot.Id} and my name is {_bot.FirstName}.");
